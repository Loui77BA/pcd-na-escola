        ...
        <div class="row gx-5 align-items-center justify-content-center">
            <div class="col-lg-7 col-xl-6 mb-5 mb-xl-0">
                <div class="text-center text-xl-start">
                    ...
                    <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start mt-5">
                        <a class="btn btn-primary-custom btn-lg px-4 py-3 rounded-pill d-flex align-items-center justify-content-center" href="#target-audiences" role="button">
                            <i class="material-icons me-2" aria-hidden="true">explore</i>
                            <span>Saiba mais</span>
                        </a>
                        <a class="btn btn-outline-custom btn-lg px-4 py-3 rounded-pill d-flex align-items-center justify-content-center" href="/contato" role="button">
        ...
        <div class="row gx-4 gy-4 justify-content-center">
            <div class="col-lg-3 col-md-6">
                <div class="custom-card text-center">
                    <div class="card-icon-wrapper mx-auto">
            ...
            <div class="col-lg-6 mb-5 mb-lg-0">
                ...
                <div class="custom-card p-4 border-start border-4 border-primary">
                    <p class="mb-0 text-white">
                        <i class="material-icons align-middle me-2 text-gradient" aria-hidden="true">warning</i>
        ...
        <div class="row gx-4 gy-4 justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="custom-card text-center h-100">
                    <div class="card-icon-wrapper mx-auto rounded-circle">
